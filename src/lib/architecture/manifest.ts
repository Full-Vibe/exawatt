    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          summary:
            'Immediate milestone-driven launch frame, versioned local renderer with warm prestart, main-process PKCE OAuth with canonical renderer-cookie persistence, serialized workspace/history durability, bounded provider discovery and renderer caching, verified two-commit Session shutdown, plus signed automatic updates.',
          layer: 'infrastructure',
          status: 'implemented',
          x: 75,
          y: 685,
