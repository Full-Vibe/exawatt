...
const DARK_BACKDROP_VARIANT_IDS = new Set([
  'smoke-low',
  'original-optic',
  'original-satin',
  'original-smoke',
...
export function KeySwitchStudy({
  ...
  return (
    ...
    >
      <div className="relative h-112 sm:h-128 xl:h-160">
        <Canvas
          aria-hidden="true"
          camera={{
            fov: 29,
        ...
        <div
          className={`pointer-events-none absolute left-5 flex items-center gap-2.5 sm:left-7 ${
            evalMode ? 'top-16' : 'top-5 sm:top-7'
          }`}
        >
          <span
          ...
          <span
            ...
            style={{
              color:
                DARK_BACKDROP_VARIANT_IDS.has(variant.id)
        ...
        <button
          className={`absolute right-5 rounded-sm border bg-slate-950/55 px-3 py-2 font-mono text-chrome-micro uppercase tracking-[0.16em] text-slate-100 outline-none backdrop-blur-sm transition-colors hover:bg-slate-950/70 focus-visible:ring-2 focus-visible:ring-sky-200 sm:right-7 ${
            evalMode ? 'top-16' : 'top-5 sm:top-7'
          }`}
        ...
        <button
          ...
          className={`absolute right-5 rounded-sm border bg-slate-950/55 px-3 py-2 font-mono text-chrome-micro uppercase tracking-[0.16em] text-slate-100 outline-none backdrop-blur-sm transition-colors hover:bg-slate-950/70 focus-visible:ring-2 focus-visible:ring-sky-200 sm:right-7 ${
            evalMode ? 'top-28' : 'top-16 sm:top-17'
          }`}
        ...
        <button
          ...
          className={`absolute right-5 rounded-sm border bg-slate-950/55 px-3 py-2 font-mono text-chrome-micro uppercase tracking-[0.16em] text-slate-100 outline-none backdrop-blur-sm transition-colors hover:bg-slate-950/70 focus-visible:ring-2 focus-visible:ring-sky-200 sm:right-7 ${
            evalMode ? 'top-40' : 'top-28 sm:top-30'
          }`}
        ...
        <button
          className="absolute bottom-5 left-5 rounded-sm border bg-slate-950/55 px-3 py-2 font-mono text-chrome-micro uppercase tracking-[0.16em] text-slate-100 outline-none backdrop-blur-sm transition-colors hover:bg-slate-950/70 focus-visible:ring-2 focus-visible:ring-sky-200 sm:bottom-7 sm:left-7"
        ...
        <p className="pointer-events-none absolute bottom-16 left-5 right-5 rounded-sm bg-slate-950/45 px-2.5 py-1.5 text-center font-mono text-chrome-micro uppercase tracking-[0.16em] text-slate-100/75 backdrop-blur-sm sm:bottom-7 sm:left-auto sm:right-7">
        ...
        {KEYSWITCH_VARIANTS.map(candidate => {
          ...
          return (
            <button
              key={candidate.id}
              aria-pressed={active}
              className="flex min-h-36 items-start gap-4 border-b px-5 py-5 text-left outline-none transition-[background-color] duration-200 last:border-b-0 focus-visible:bg-sky-100/[0.07] md:odd:border-r 2xl:border-b-0 2xl:border-r 2xl:last:border-r-0"
              ...
              type="button"
            >
              <span className="mt-0.5 font-mono text-chrome-micro tracking-[0.18em] text-sky-200/45">
                {candidate.index}
              </span>
              <span className="flex min-w-0 flex-col gap-1.5">
                <span className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
                  ...
                  <span className="font-mono text-chrome-micro uppercase tracking-[0.12em] text-sky-200/55">
                    {candidate.short}
                  </span>
                </span>
                ...
                <span className="mt-1 font-mono text-chrome-micro uppercase tracking-[0.1em] text-slate-500">
                  {candidate.materials}
                </span>
                <span className="font-mono text-chrome-micro uppercase tracking-[0.1em] text-sky-200/45">
                  Sound ·{' '}
