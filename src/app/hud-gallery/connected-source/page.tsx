...
import { ConnectedSourceStudy } from './study';

export default function ConnectedSourceBenchPage() {
  return (
    <main
        ...
        <header className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-end sm:gap-6">
          <div>
            ...
            <p
              ...
              style={{ color: HUD.textDim }}
            >
              Remote coworkers in the same roster as local ones. Placement,
              connection freshness, and D40 work state are three separate facts,
              and the whole roster stays readable with colour switched off.
            </p>
          </div>
          <Link
