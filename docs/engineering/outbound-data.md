...
| Operator profile / stats (`/api/operator-stats`) | GitHub identity plus numeric day and Run aggregates; no Project, path, or prompt data | **Explicit opt-in** (decision `0029`); `DELETE` removes it |
