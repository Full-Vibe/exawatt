...
| `/hud-gallery/goal-visuals`                                                                                                                            | **Keep (active review candidate)**                                                 | full-card-only matrix comparing material macro, aerial structure, and graphic form across three stable goal identities in the exact 272×252 Team hierarchy; retire after one visual language ships                                                                                   |
