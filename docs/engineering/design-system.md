...
| `/hud-gallery/goal-visuals`                                                                                                                            | **Keep (active review candidate)**                                                 | compares five image geometries in the exact 272×252 Team tile hierarchy and three stable goal identities; retire after one treatment ships                                                                                                                                           |
