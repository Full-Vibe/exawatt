...
| `/hud-gallery/team-order`                                                                                                                              | **Keep (active review candidate)**                                                 | ENG-015 S6.2: the real Team altitude over a fixture fleet behind a candidate order strip (FIX-008); retire once the operator's pick ships in production chrome                                                                                                                                       |
